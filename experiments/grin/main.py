...
from src.models.grin import GRINet
from src.trainers.grin_trainer import GRIN_Trainer
...
def get_config():
    ...
    parser.add_argument('--d_u', type=int, default=0)
    ...
    parser.add_argument('--layer-norm', nargs='?', const=True, default=False)
    parser.add_argument('--global-att', nargs='?', const=True, default=False)
    parser.add_argument('--merge', type=str, default='mlp')
    parser.add_argument('--impute-only-holes', nargs='?', const=True, default=True)
...
def main():
    ...
    trainer = GRIN_Trainer(model=model,
                            adj_mat=adj_mat,
